Technology to support an array of different 'currencies' is thought to be important. Noting, that the term 'currencies' is not simply or solely about money; rather, it refers to a broader semantic concept of socio-economic & biosphere interactions in particular (there are others).

Therein also:  support for Micropayments is incredibly important, yet the modelling for how micropayments are achieved also needs to take into consideration the cost of energy and other supply / distribution chain related costing frameworks. 
